...
public class AmmoniteCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject ammoniteCamera;
	...
	void Update(){
		...
		CameraRotationX ();
		CameraRotationY ();
		cameraDistance=cameraDistance+Input.GetAxis ("Mouse ScrollWheel") *Time.deltaTime*cameraDistance;
		ammoniteCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
