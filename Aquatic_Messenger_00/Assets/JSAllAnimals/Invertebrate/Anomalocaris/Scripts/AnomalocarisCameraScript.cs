...
public class AnomalocarisCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject anomalocarisCamera;
	...
	void Update(){
		...
		anomalocarisCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
